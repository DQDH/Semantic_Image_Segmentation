...
if is_server
  if strcmp(dataset, 'voc12')
    VOC_root_folder = '/home/zqq/zqqHD/DataSet/Pascal/VOCdevkit';
...
output_mat_folder = fullfile('/home/zqq/zqqHD/Smantic_Segmentation/deeplabv1/exper', dataset, feature_name, model_name, testset, feature_type);

save_root_folder = fullfile('/home/zqq/zqqHD/Smantic_Segmentation/deeplabv1/exper', dataset, 'res', feature_name, model_name, testset, feature_type, post_folder);
%fprintf(1, 'Saving to %s\n', save_root_folder);

if strcmp(dataset, 'voc12')
  %seg_res_dir =['/home1/zqqHD/DataSet/Pascal/VOCdevkit/VOC2012/voc12/mycue8000-crf/',argument]
  seg_res_dir ='/home1/zqqHD/DataSet/Pascal/VOCdevkit/VOC2012/voc12/Mypaper/onlypoolnet/onlypoolnet/val8000/'
 % seg_res_dir = '/home1/zqqHD/Smantic_Segmentation/AffinityNet/psa-master/result/vgg_val-dara1/out_rw10';
 % seg_res_dir = [save_root_folder '/results/VOC2012/']; %保存的是crf推理结果
...
save_result_folder = seg_res_dir;
...
if strcmp(dataset, 'voc12')
  VOCopts = LabelGetVOCopts(seg_root, seg_res_dir, trainset, testset, 'VOC2012');
elseif strcmp(dataset, 'coco')
...
%if strcmp(testset, 'val')
  [accuracies, avacc, conf, rawcounts] = LabelMyVOCevalseg(VOCopts, id);
%else
