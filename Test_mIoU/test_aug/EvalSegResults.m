...
if is_server
  if strcmp(dataset, 'voc12')
    VOC_root_folder = '/home/hyy/rmt/data/pascal/VOCdevkit';
...
output_mat_folder = fullfile('/home/hyy/deeplabv2/exper', dataset, feature_name, model_name, testset, feature_type);

save_root_folder = fullfile('/home/hyy/deeplabv2/exper', dataset, 'res', feature_name, model_name, testset, feature_type, post_folder);
