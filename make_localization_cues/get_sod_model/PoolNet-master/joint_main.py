...
def get_test_info(sal_mode='p'):
    if sal_mode == 'e':
        ...
        image_root = '/home1/zqqHD/DataSet/Pascal/VOCdevkit/VOC2012/val'
        image_source = '/home1/zqqHD/Smantic_Segmentation/DSRG-master/training/experiment/seed_mc/list/val_id.txt'
    elif sal_mode == 'd':
