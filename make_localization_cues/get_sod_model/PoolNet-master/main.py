...
def get_test_info(sal_mode='p'):
    if sal_mode == 'e':
        image_root = './data/ECSSD/Imgs/'
        image_source = './data/ECSSD/test.lst'
    elif sal_mode == 'p':
        image_root = '/home1/zqqHD/DataSet/Pascal/VOCdevkit/VOC2012/train_aug'
        image_source = '/home1/zqqHD/Smantic_Segmentation/DSRG-master/training/experiment/seed_mc/list/train_aug_id.txt'
    elif sal_mode == 'd':
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sal_mode', type=str, default='p') # Test image dataset
