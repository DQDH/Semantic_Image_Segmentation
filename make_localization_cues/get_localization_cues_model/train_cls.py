...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", default='../../pretrained_model/localization_cues/vgg16_20M.caffemodel', type=str)
    parser.add_argument("--train_list", default="../../list/train_aug.txt", type=str)
    parser.add_argument("--val_list", default="../../list/val.txt", type=str)
    parser.add_argument("--session_name", default="./models/vgg_cls", type=str)
    parser.add_argument("--log_name", default="./log/vgg_cls", type=str)
    ...
    train_dataset = tool.data.VOC12ClsDataset(args.train_list,args.label_npy, voc12_root=args.voc12_root,
    ...
    val_dataset = tool.data.VOC12ClsDataset(args.val_list,args.label_npy, voc12_root=args.voc12_root,
                                             transform=transforms.Compose([
                        np.asarray,
                        model.normalize,
    ...
    for ep in range(args.max_epoches):
        ...
        for iter, pack in enumerate(train_data_loader):
            ...
            timer.reset_stage()
            torch.save(model.module.state_dict(), args.session_name +str(ep+1)+ '.pth')
